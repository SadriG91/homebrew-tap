class Fanknob < Formula
  ...
  bottle do
    root_url "https://github.com/SadriG91/fanknob/archive/refs/tags/v1.0.2.tar.gz"
    sha256 cellar: :any_skip_relocation, all: "c563c8e0645beea567959428f9b9d49ff6fd6157267e7036c21c7e4ad4dc4f44"
  end
